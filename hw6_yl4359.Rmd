...
The 95% confidence interval for $\hat r^2$ is (`r quantile_r[[1]]`, `r quantile_r[[2]]`).
...
The 95% confidence interval for $\log(\hat\beta_0*\hat\beta_1)$ is (`r quantile_beta[[1]]`, `r quantile_beta[[2]]`).